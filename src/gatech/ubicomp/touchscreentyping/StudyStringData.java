...
public class StudyStringData {
	public static String[] phrasesArray = {"my watch fell in the water",
		...
		"labor unions know how to organize",
		...
		"a rattlesnake is very poisonous",
	...
	public static String[] warmUpStrings = {"abc defgh ij k lmnop qr st uv wx yz", 
		"a bc de fghi jk lmn opqr st uvw xyz"};
